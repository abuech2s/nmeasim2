...
public abstract class AbstractFishersSource extends AISAbstractSource {
	
	private static final Logger log = LoggerFactory.getLogger(AbstractFishersSource.class);
	
	private List<GeoCoordinate> waypoints;
	
	private String vesselName;
	
	public AbstractFishersSource(String vesselName, List<GeoCoordinate> waypoints) {
		super();
	...
	public void init() {
		...
		vessel = VesselFactory.createFisherVessel(this.vesselName);
		...
		log.info("Fisher ship created: {} dist={}m, time={}s, points={}", mmsi, (int)totalDistance, (int)totalTime, nrOfPoints);
	}
