...
public abstract class AbstractPatrolSource extends AISAbstractSource {
	
	private static final Logger log = LoggerFactory.getLogger(AbstractPatrolSource.class);
	
	private List<GeoCoordinate> waypoints;
	
	private String vesselName;
	
	public AbstractPatrolSource(String vesselName, List<GeoCoordinate> waypoints) {
		super();
	...
	public void init() {
		...
		vessel = VesselFactory.createRussianVessel(this.vesselName);
		...
		log.info("Patrol ship created: {} dist={}m, time={}s, points={}", mmsi, (int)totalDistance, (int)totalTime, nrOfPoints);
	}
